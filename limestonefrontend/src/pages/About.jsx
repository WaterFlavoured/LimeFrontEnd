  ...
  return (
    ...
    <div className='about'>
      ...
      <div className='tempBlock'>
        ...
        <body>We provide durable and reliable foundation solutions <br />
      ...
      <div className='tempBlock'>
        ...
        <img className='oVphoto' src={logo} alt=""></img>

        <div className='ourVisMeow'>

          <h1>OUR VISION</h1>

          <body>Our vision is to build more than just foundations—we <br />
