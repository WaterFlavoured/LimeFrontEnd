...
const About = () => {
  return (
    <div>
      ...
      <h1><img src={image1} alt=""></img></h1>

      <div><img src={logo} alt=""></img> <br />

        <div>

          <h1>ABOUT LIMESTONE CONCRETE</h1>
          <body>At Limestone Concrete, we’re a family-owned business in London, Ontario,<br />
      ...
      <div>
        ...
        <body>**Our Duties**  
        At Limestone Concrete, our duties go beyond delivering exceptional foundations. <br/>
